...
export class ResponseExceptionFilter implements ExceptionFilter {
	...
	constructor(
		...
		if (exception instanceof BadRequestException) {
			...
			if (Array.isArray(exceptionMessage)) {
				validationMessages = this.messageService.translateValidationMessages(exceptionMessage, lang)
	...
	private captureSentryException(exception: unknown, request: Request, errorResponse: IApiErrorResponse): void {
