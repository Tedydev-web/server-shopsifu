...
@Module({
	imports: [AwsModule],
	providers: [JwtService, HelperEncryptionService, HelperEmailService, HelperPaginationService],
	exports: [HelperEncryptionService, HelperEmailService, HelperPaginationService]
})
