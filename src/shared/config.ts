...
const configSchema = z.object({
  ...
  DEFAULT_REFRESH_TOKEN_EXPIRES_IN: z.string().default('1d'),
...
const envConfig = {
  ...
  DEFAULT_REFRESH_TOKEN_COOKIE_MAX_AGE: ms(configServer.data.DEFAULT_REFRESH_TOKEN_EXPIRES_IN),
...
console.log('[DEBUG] Loaded envConfig in config.ts:', {
  ...
  DEFAULT_REFRESH_TOKEN_EXPIRES_IN: envConfig.DEFAULT_REFRESH_TOKEN_EXPIRES_IN,
  DEFAULT_REFRESH_TOKEN_COOKIE_MAX_AGE: envConfig.DEFAULT_REFRESH_TOKEN_COOKIE_MAX_AGE,
