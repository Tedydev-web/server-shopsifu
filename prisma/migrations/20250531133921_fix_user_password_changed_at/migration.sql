...
-- CreateEnum
CREATE TYPE "VerificationCodeType" AS ENUM ('REGISTER', 'RESET_PASSWORD', 'LOGIN', 'LOGIN_UNTRUSTED_DEVICE_2FA', 'DISABLE_2FA', 'SETUP_2FA', 'LOGIN_UNTRUSTED_DEVICE_OTP', 'VERIFY_SECONDARY_EMAIL', 'VERIFY_PHONE_NUMBER');
